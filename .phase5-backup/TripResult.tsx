...
import { enrichTripPlaces, editTrip, generateTrip, getTrip, saveLastTripId, type TripAlternative, type TripDetail } from "@/lib/trips";
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-5">
            ...
            <div className="flex gap-2 flex-wrap">
              <button
                type="button"
                onClick={() => {
                  setChatInitialInput("I'd like to make some changes to my itinerary: ");
                  setIsChatOpen(true);
                }}
